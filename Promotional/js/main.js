...
function myFunction(link){
  ...
  switch(link){
    case 'hipHopLink':
      URL = "https://gist.githubusercontent.com/anthonyg56/ed657382cf8bb4973ae6f7bfaf8d1189/raw/f54098b098ae39484d58fa6064f25c599115003d/hipHopArtists.json";
      break;
    case 'producersLink':
      URL = "https://gist.githubusercontent.com/anthonyg56/ed657382cf8bb4973ae6f7bfaf8d1189/raw/ab1de9a6302b3490dc4c7446a3577fec6a3ba450/producersArtists.json";
      break;
    case 'cinemaLink':
      URL = "https://gist.githubusercontent.com/anthonyg56/ed657382cf8bb4973ae6f7bfaf8d1189/raw/3b13079baf9a66af97c397d94033ac3d302b2384/cinemaArtists.json";
      break;
    case 'bandsLink':
      URL = "https://gist.githubusercontent.com/anthonyg56/ed657382cf8bb4973ae6f7bfaf8d1189/raw/3b13079baf9a66af97c397d94033ac3d302b2384/bandsArtists.json";
      break;
    case 'featuredLink':
      URL = "https://gist.githubusercontent.com/anthonyg56/ed657382cf8bb4973ae6f7bfaf8d1189/raw/3b13079baf9a66af97c397d94033ac3d302b2384/featuredArtists.json";
      break;
    case 'eventsLink':
      URL = "https://gist.githubusercontent.com/anthonyg56/ed657382cf8bb4973ae6f7bfaf8d1189/raw/7d1111e4f85699fa890aec87522737b398ac125d/events.json";
      break;
  }
  console.log(URL);
  ajaxCall(false);
...
function renderHTML(info){
  ...
  html += '<h1 style="color: #DAA520; font-size: 4em; font-weight: 600; margin-top: 100px;">Local ' + info[0].genre + ' Artists</h1>';
  for (var x = 0; x < info.length; x++) {
    html += '<div class="container text-center" id="hipHopDiv" style="border-radius: 25px; margin: 35px auto; background: rgba(0, 0, 128, .7); padding: 0; box-shadow: 3px 5px 6px ;">' + 
              '<div class="row" style="padding: 0;">' + 
                ...
                '<div class="col-sm-6 col-lg-6 col-md-6" id="hipHopInfo" style="padding: 20px 0; height">' +
                  ...
                  '<a onclick="ajaxCall(true, ' + x +')" style=" background-color: #DAA520; color: #000080; font-weight: 600; border-radius: 25px; padding: 15px 30px; font-size: 1.5em; text-decoration: none;' +
                  '">View Profile</a>' +
                '</div>' +
              '</div>' +
            '</div>';
  ...
  html += '<div>' +
            '<button onclick="renderHTML(null)" style="background-color: #DAA520; color: #000080; font-weight: 600; border-radius: 25px; border-color: #DAA520; padding: 15px 45px 15px 45px; font-size: 2em; font-family: "lato"; text-decoration: none;"> Go Back To Artists </button>' +
          '</div>';
...
function loadProfile(g, y){
  ...
  html = '<div class="container text-center" style="margin: 75px auto 45px auto; font-family: "lato";">' +
            '<div class="row" style="padding: 25px 0 10px 0;">' + 
              '<h1 style="color: #DAA520; font-size: 4.5em; font-weight: 600; letter-spacing: 3px;">'+ g[y].name + '</h1>' +
            '</div>' +
            '<div class="row" style="margin: 20px auto; padding: 45px 20px 45px 20px; background: rgba(0, 0, 128, .7); border-radius: 25px;">' +
              '<div class="col-sm-6 col-lg-6 col-md-6">' +
                '<img src="' + g[y].pic +'" class="img-responsive"/ style="border-radius: 25px;">'+
              '</div>'+
              '<div class="col-sm-6 col-lg-6 col-md-6">' +
                '<h2 style="font-weight: 600; color: #DAA520; padding: 8px 0; letter-spacing: 2px;">About ' + g[y].name + '</h2>' +
          ...
          '</div>' +
          '<div>' +
            '<button onclick="ajaxCall(false)" style="background-color: #DAA520; color: #000080; font-weight: 600; border-radius: 25px; border-color: #DAA520; padding: 15px 45px 15px 45px; font-size: 2em; text-decoration: none; margin-: 0 auto 30px auto; font-family: \"lato\"; "> Go Back to ' + g[y].genre +  ' Artists </button>' +
          '</div>' ;
  artProfile.insertAdjacentHTML('afterbegin', html);
};